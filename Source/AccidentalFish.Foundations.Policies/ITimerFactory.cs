...
namespace AccidentalFish.ApplicationSupport.Policies
{
    ...
    public interface ITimerFactory
    {
        ...
        IAsyncIntervalTimer CreateAsyncIntervalTimer(TimeSpan interval, bool delayOnExecute = false);
        /// <summary>
        ...
        IAsyncRegularTimer CreateAsyncRegularTimer(TimeSpan interval, bool delayOnExecute = false);
    }
}