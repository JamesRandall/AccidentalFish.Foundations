...
namespace AccidentalFish.Foundations.Resources.Abstractions.Queues
{
    ...
    public interface ILargeMessageQueueFactory
    {
        ...
        ILargeMessageQueue<T> Create<T>(string queueName, string blobContainerName) where T : class;
        ...
        /// <returns>A queue</returns>
        ILargeMessageQueue<T> Create<T>(string queueName, string blobContainerName, ILargeMessageQueueErrorHandler errorHandler) where T : class;
