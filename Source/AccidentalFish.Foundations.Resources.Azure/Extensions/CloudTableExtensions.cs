...
namespace AccidentalFish.Foundations.Resources.Azure.Extensions
{
    ...
    {
        public static async Task<IReadOnlyCollection<T>> ExecuteQueryAsync<T>(this CloudTable table, TableQuery<T> query, Action<IList<T>> onProgress = null) where T : ITableEntity, new()
        {
